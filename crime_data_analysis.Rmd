...
Given that the population of Seattle in 2014 was 668,000, the number of recorded cases of drug crimes seems strikingly low. (Including the cases for which coordinate data is missing, the number of recorded cases is 391.) With this in mind, compare the results with the equivalent results for San Fransisco.

```{r}
fred <- calculate_conditional_distribution(Summarized.Offense.Description)[[1]]
```
