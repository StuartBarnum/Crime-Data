...
Looking somewhat deeper at the recorded cases of drug crime in the two cities, consider the differences between crimes that would be considered trafficking (sales, transportation, and, in my schema, production) and those that would be considered possession.
