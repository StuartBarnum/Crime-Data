...
Looking somewhat deeper at the recorded cases of illegal drug use in the two cities, let's consider the differences between crimes that would be considered trafficking (sales, transportation, or production) and those that would be considered possession.
